<?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tb_keluar WHERE id='$id'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Update Data Barang Keluar</h3>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-edit"></span> Update Barang Keluar</button>
                            </div>
                        </div>
                    </form>
...
if($_POST){
  ...
  $jumlah=$_POST['jumlah_barang'];
    //buat sql
    $sql="UPDATE tb_keluar SET nama_barang= '$nama', tanggal='$tanggal', jumlah_barang='$jumlah' WHERE id='$id'"; 
