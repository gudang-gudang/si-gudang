<?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tb_barang WHERE id ='$id'") or die ("SQL Edit error");
...
if($_POST){
   ...
   $nama=$_POST['nama_barang'];
    ...
    $sql="UPDATE tb_barang SET nama_barang='$nama',tanggal='$tanggal',jumlah_barang='$jumlah 'WHERE id ='$id'"; 
